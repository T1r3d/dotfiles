...
export ZSH="/Users/t1r3d/.oh-my-zsh"
...
alias java8='JAVA_HOME=`/usr/libexec/java_home -v 1.8`;export JAVA_HOME;$JAVA_HOME/bin/java'
alias java11='JAVA_HOME=`/usr/libexec/java_home -v 11`;export JAVA_HOME;$JAVA_HOME/bin/java'
